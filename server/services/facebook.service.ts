...
const mockFacebookPosts: FacebookPostData[] = [
  {
    id: "post_fb_001",
    message:
      "Excited to announce our latest tech breakthrough! 🔬 #innovation #tech",
  ...
  },
  {
    id: "post_fb_003",
    message:
      "Thank you for 10k followers! Celebrating this milestone with you all 🎉",
...
export async function fetchFacebookRealtime(
  profileUrl: string,
  accessToken?: string,
